...
function update()
    if updateCheck == false then
        ...
        elseif latestVersion == VERSION then
            updateCheck = true
            PrintChat("Your Version of R&BYasuo is up to date")
        end
    end
end
...
function OnLoad()
	...
	PrintChat("<font color='#aaff34'>R</font><font color='#aaff44'>&</font><font color='#aaff54'>B</font><font color='#44BB77'>Y</font><font color='#44BB87'>a</font><font color='#44BB97'>s</font><font color='#44BBa7'>u</font><font color='#44BB7b'>o</font> <font color='#99ff88'>"..VERSION.."</font> <font color='#BBBBBB'> by</font> <font color='#9999ff'>X-Box</font>")
    Menu()
    Init()
    if VIP_USER then
...
function Menu()
	Config = scriptConfig("R&B - Yasuo", "yasuo")
